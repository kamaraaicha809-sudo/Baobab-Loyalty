          ...
          <div>
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-50 border border-amber-200 mb-4">
              ...
              <p className="text-sm text-amber-800">
                Quand un client réserve depuis un lien WhatsApp, la réception reçoit automatiquement un message WhatsApp <strong>et</strong> un email pour vérifier la disponibilité avant de confirmer.
              </p>
            </div>

            {/* Numéro expéditeur Baobab Loyalty */}
            <div className="mb-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
              <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Numéro WhatsApp expéditeur (Baobab Loyalty)</p>
              {waStatus.connected && waStatus.phone ? (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-800">
                      {waStatus.phone.startsWith("+") ? waStatus.phone : `+${waStatus.phone}`}
                    </p>
                    <p className="text-xs text-slate-500">C&apos;est ce numéro qui envoie les notifications WhatsApp à la réception</p>
                  </div>
                  <span className="ml-auto inline-flex items-center gap-1 px-2 py-1 rounded-full bg-green-50 border border-green-200 text-green-700 text-xs font-semibold shrink-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-slate-600">
                    Aucun numéro connecté — connectez WhatsApp Business ci-dessous pour activer les notifications WhatsApp.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="reception_email" className={labelClass}>
                  Email de la réception
                  <span className="ml-1 text-xs font-normal text-slate-400">(reçoit l&apos;alerte par email)</span>
                </label>
                <input
                  id="reception_email"
                  type="email"
              ...
              <div>
                <label htmlFor="reception_whatsapp" className={labelClass}>
                  WhatsApp de la réception
                  <span className="ml-1 text-xs font-normal text-slate-400">(reçoit l&apos;alerte WhatsApp)</span>
                </label>
                <input
