...
const data: CountryPageData = {
  ...
  guarantee: {
    ...
    text: "Baobab Loyalty est encore jeune au Sénégal — on n'a pas des centaines d'avis à vous montrer. Alors on préfère vous le prouver autrement : si vous ne récupérez pas au moins 2 réservations directes supplémentaires le premier mois, on vous offre le mois suivant.",
  ...
  return (
    <>
      ...
      {renderBreadcrumbSchema([
        ...
        { name: "Sénégal", urlRelative: "/senegal" },
      ])}
      <Suspense>
        <Header />
      </Suspense>
