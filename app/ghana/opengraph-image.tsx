...
export const alt = config.region === "europe" ? "Loyavia" : "Baobab Loyalty — Hotel loyalty software for Ghana";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Grow your hotel&apos;s direct bookings in{" "}
          <span style={{ color: "#EBC161" }}>Accra</span>
          {" "}via WhatsApp
        </h1>
