...
export const alt = "Baobab Loyalty — Fidélisation hôtelière en Côte d'Ivoire";
    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#EBC161" }}>Abidjan</span>
          {" "}via WhatsApp
        </h1>
        ...
        <div style={{ display: "flex", gap: 16 }}>
          {[
            { value: "85%", label: "utilisateurs WhatsApp" },
        ...
        >
          baobabloyalty.com/cote-divoire
        </div>
      </div>
    ),
    { ...size }
