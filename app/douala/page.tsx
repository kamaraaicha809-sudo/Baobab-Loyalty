...
const data: CountryPageData = {
  ...
  guarantee: {
    ...
    text: "Baobab Loyalty est encore jeune à Douala — on n'a pas des centaines d'avis à vous montrer. Alors on préfère vous le prouver autrement : si vous ne récupérez pas au moins 2 réservations directes supplémentaires au cours de votre premier mois complet d'utilisation, on vous offre le mois suivant, à condition que votre base clients ait été correctement importée et qu'au moins une campagne ait été envoyée.",
