...
export default function SignUp() {
  ...
  // Afficher un loader pendant la redirection en mode démo
  if (isDemoMode) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-slate-200 border-t-primary rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-slate-500">Mode démo - Redirection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="space-y-5 sm:space-y-6">
            {/* Google OAuth */}
            <button
              className="w-full flex items-center justify-center gap-3 px-4 sm:px-6 py-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 font-medium transition-all text-sm sm:text-base cursor-pointer"
