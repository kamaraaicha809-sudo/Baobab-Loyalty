...
const data: CountryPageData = {
  ...
  problemPoints: [
    {
      ...
      desc: "Votre client d'affaires séjourne au Plateau, repart satisfait — mais sans recontact ciblé, il réserve un concurrent la prochaine fois. La majorité des clients ne reviennent pas sans relance proactive.",
    },
    {
  ...
  guarantee: {
    ...
    text: "Baobab Loyalty est encore jeune à Abidjan — on n'a pas des centaines d'avis à vous montrer. Alors on préfère vous le prouver autrement : si vous ne récupérez pas au moins 2 réservations directes supplémentaires le premier mois, on vous offre le mois suivant.",
  ...
  return (
    <>
      ...
      {renderBreadcrumbSchema([
        ...
        { name: "Abidjan", urlRelative: "/abidjan" },
      ])}
      <Suspense>
        <Header />
      </Suspense>
