/**
 * Textes des 3 templates d'anniversaire (V1) — miroir Deno de
 * src/lib/birthday-templates.ts. Duplique volontairement le contenu :
 * aucun import cross-runtime possible entre Next.js et une Edge Function
 * Deno (meme convention que _shared/consent-policy.ts). Garder les deux
 * fichiers synchronises si les textes changent.
 */
