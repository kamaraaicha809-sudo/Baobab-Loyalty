const features = [
  ...
  },
  {
    ...
    title: "Tu récupères des réservations directes",
    desc: "Tes clients réservent directement, sans passer par Booking.com. Tu gardes 100% de chaque réservation — zéro commission à payer.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "L'IA rédige les messages à ta place",
    desc: "Tu ne sais pas quoi écrire ? L'IA génère un message WhatsApp personnalisé et convaincant en quelques secondes. Tu valides, tu envoies.",
  },
];
