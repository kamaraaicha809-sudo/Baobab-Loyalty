const features = [
  {
    ...
    desc: "Notre IA vous aide à identifier la liste des clients souhaités.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Touchez vos clients là où ils sont. WhatsApp offre un taux d'ouverture 5x supérieur à l'email.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Lancez une campagne complète en moins de 2 minutes, du choix du segment à l'envoi.",
  },
];
