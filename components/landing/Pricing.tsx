              ...
              >
                ...
                <ul className="flex-1 space-y-3 mb-8 text-slate-300 text-sm">
                  {config.region === "europe" &&
                    [
                      "monthlyRelances" in plan && plan.monthlyRelances != null
                        ? `${plan.monthlyRelances} campagnes WhatsApp / mois`
                        : null,
                      "maxRooms" in plan
                        ? plan.maxRooms === null
                          ? "Chambres illimitées"
                        ...
                        : null,
                      "maxRooms" in plan ? "Segmentation clients (3, 6, 9 mois)" : null,
                    ]
                      .filter((line): line is string => !!line)
                      .map((line, j) => (
                        <li key={`quota-${j}`} className="flex items-center gap-2">
